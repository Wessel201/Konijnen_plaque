...
$$P_f(t)=M_f$$
$$P_f(t)=919996$$
This shows that the equilibrium solutions are 0 and 919996. Now adding the rabbits to the equation, we find that, as red foxes eat around 500 grams of food per day, a red fox needs 0.25 rabbits a day. This means that for every fox 0.25 rabbit die, on top of the constant death rate of the rabbits. This means that the derivative equation for the rabbits becomes
$$\frac{dP_r(t)}{dt}=R_rP_r(t)(1-\frac{P_r(t)}{M_r})-0.25P_r(t)P_f(t)$$
Where $P_r(t)$ is the amount of rabbits, $R_r$ the birthrate minus the deathrate of the rabbits and $M_r$ is the maximum amount of rabbits Australia can house.
